...
function content(){
 ...
 $address_dl->addElement(api_text("training_view-dt-name"),$address->name);
 $address_dl->addElement(api_text("training_view-dt-sex"),$address->sexText);
 $address_dl->addElement(api_text("training_view-dt-birthday"),api_timestampFormat($address->birthday,api_text("date")));
